...
class PaypalStandard extends Model {
	...
	private function call($data){
		...
		$settings = array(
			...
			'USER' => urlencode($this->payment_settings['pp_api_username']),
			'PWD' => urlencode($this->payment_settings['pp_api_password']),
			'SIGNATURE' => urlencode($this->payment_settings['pp_api_signature']),
