...
<g>
	...
	<path d="M412.803,294.197c-2.929-2.929-7.678-2.929-10.606,0L351.5,344.894l-50.697-50.697c-2.929-2.929-7.678-2.929-10.606,0
		...
		C415.732,301.875,415.732,297.125,412.803,294.197z"/>
					        ...
					        <h2><span><?php echo Utilities::getLabel('L_Payment_Failed')?></span></h2>
					        <div class="gap"></div>
						        <?php echo Utilities::renderHtml($text_message)?>
					        <div class="gap"></div>
			        </div>
                     <?php if(!$hide_header_footer){?>
					     <a href="<?php echo Utilities::getSiteUrl(); ?>" class="btn green"><?php echo Utilities::getLabel('L_Back_to_home')?></a>
					 <?php }?> 
       				 </div>
			        </div>
        		</div>
