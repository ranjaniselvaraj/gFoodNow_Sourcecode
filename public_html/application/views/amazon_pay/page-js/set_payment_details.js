			...
			$(document).on('click', '.amazon-submit', function(){
				if(typeof orderRefId != typeof undefined && typeof orderId != typeof undefined){
					if(orderRefId != '' && orderId != ''){
						if($ajax){
							$ajax = false;
							$('.payment-from .amazon-submit-wrap .amazon-submit').text('Please Wait...');
							callAjax(generateUrl('amazon_pay', 'doPayment', [orderId]), 'amazon_order_reference_id='+orderRefId, function(data){
