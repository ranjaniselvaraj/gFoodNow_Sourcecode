<div class="seller-left">
	 ...
	 viewBox="0 0 488.3 488.3" style="enable-background:new 0 0 488.3 488.3;" xml:space="preserve">
                ...
                <h3><?php echo Utilities::getLabel('L_Get_Your_Business_Online')?></h3>
                <ul>
                  <li><?php echo Utilities::getLabel('L_Register_Your_Account_Now')?></li>
                  <li><?php echo Utilities::getLabel('L_Open_Your_Shop')?></li>
                  <li><?php echo Utilities::getLabel('L_Start_Selling_Grow_Your_Business')?></li>
                </ul>
              </div>
            </div>