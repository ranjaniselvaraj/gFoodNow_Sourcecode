              ...
              <div class="sell-form">
                <div class="seller-steps">
        	       <ul>
	               	...
	               	<li class="compeleted"><a href="<?php echo Utilities::generateUrl('supplier', 'account')?>"><?php echo Utilities::getLabel('L_Seller_Profile_Activation')?></a></li>
    	           	<li class="active"><a href="#"><?php echo Utilities::getLabel('L_Confirmation')?></a></li>
              	   </ul>
                </div>
		...
		C415.732,301.875,415.732,297.125,412.803,294.197z"/>
				          ...
				          <div class="gap"></div>
					          <h6><strong>Hi <?php echo $supplier_request["user_name"]?></strong><br>
                                ...
                                <a class="btn secondary-btn" href="<?php echo Utilities::generateUrl('supplier', 'profile_activation',array('reopen')); ?>"><?php echo Utilities::getLabel('L_Submit_Revised_Request')?></a>
                      	 ...
                      	 <?php } ?>
                      <a class="btn" href="<?php echo Utilities::getSiteUrl(); ?>"><?php echo Utilities::getLabel('L_Back_to_home_page')?></a> 
                      </div>
