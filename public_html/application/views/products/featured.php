...
<input type="hidden" name="property[]" value="prod_featuered"/>
<div>
      ...
      <div class="breadcrumb">
        <div class="fixed-container">
          <ul>
            ...
            <li><?php echo Utilities::getLabel('L_Featured_Products') ?></li>
          </ul>
        </div>
      </div>
      <div class="pageBar">
        <div class="fixed-container">
          <h1 class="pageTitle"><?php echo Utilities::getLabel('L_Featured_Products') ?></h1>
                ...
                <div class="box_Middle toggleWrap">
                  <div class="listscroll">
                    <ul class="labelList">
                      <li>
                        <label><span class="span1">
                          <input class="free_shipping" <?php if (in_array('prod_ship_free',$get["property"])):?> checked="checked" <?php endif;?>  name="property[]" value="prod_ship_free" type="checkbox" value="1">
