      ...
      <div class="fixed-container">
        ...
        <div class="shop-page">
          ...
          <div class="right-panel">
          	 <h3><?php echo Utilities::getLabel('F_who_favorited_this')?> <?php echo $total_records?> <?php echo Utilities::getLabel('F_people_admire_this')?></h3>	
                   ...
                   <?php if ($total_records>0) {?>
            	    ...
            	    <div class="space-lft-right">
	                                <div class="notification informationfullwidth">
							            ...
							            <?php echo Utilities::getLabel('L_Unable_to_find_any_record')?></p>
						            </div>
                                </div>
                <?php }?>
            </div>
