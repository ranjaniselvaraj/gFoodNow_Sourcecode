...
<input type="hidden" name="category" value="<?php echo $get['category']?>" id="category_id"/>
<div>
    <div class="body clearfix">
      ...
      <div class="pageBar">
        <div class="fixed-container">
          <h1 class="pageTitle"><?php echo $brand["brand_name"]?></h1>
          ...
          <div class="mobile-element">
            <div class="mobile-filter">
              <ul>
                ...
                <li><a href="#"  class="click_trigger" id="ct_6"><i class="icn-sort"></i><?php echo Utilities::getLabel('M_sort')?></a>
 ...
 <div class="filter-popup no-action" id="list_ct_4">
  ...
  <div id="tab-2" class="filter-list">
    <ul>
      ...
      <li><label><span class="filter-name"><span class="facetoption">
        <input name="brand[]" type="checkbox" class="brands faceoption" value="<?php echo $val["brand_id"]?>" >
        </span></label><?php echo $val["brand_name"]?></span></li>
      <? endforeach; ?>  
    </ul>
  </div>
  <?php if (isset($price_range['min_price']) && isset($price_range['max_price'])) { ?>
