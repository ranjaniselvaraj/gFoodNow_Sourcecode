        ...
        <div class="data-side">
          ...
          <div class="referral">
                <div class="space-lft-right">
                  <h3><?php echo Utilities::getLabel('L_Share_and_Earn')?></h3>
             	  <p><?php echo Utilities::getLabel('L_Share_And_Earn_Text_Message')?></p><br>
                  
                  <p><strong><?php echo Utilities::getLabel('L_You_may_copy_invitation_link_below')?></strong></p><br>
                  
                  <div class="alert alert-refer">
                  	<?php echo $referral_tracking_url?>
				  </div>
...
function facebook_redirect(response_token){
	   FB.ui( {
    	    ...
    	    link: "<?php echo $referral_tracking_url?>",
		...
		function( response ) {
			if ( response !== null && typeof response.post_id !== 'undefined' ) {
				$("#fb_ajax").html('<?php echo Utilities::getLabel('L_Thanks_for_sharing')?>');
			}
		});
}
...
<?
	$_SESSION["TWITTER_URL"]=Utilities::generateAbsoluteUrl('account','twitter_callback');
