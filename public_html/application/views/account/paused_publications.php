      ...
      <div class="dashboard">
        ...
        <div class="data-side">
          ...
          <ul class="arrowTabs">
                ...
                <li class="active"><a href="<?php echo Utilities::generateUrl('account', 'paused_publications')?>"><?php echo Utilities::getLabel('L_Paused_Items')?></a></li>
          </ul>
          ...
          <div class="darkgray-form clearfix">
            ...
            <div class="search-dashboard">
              <form method="post" name="frmSrchListings" id="frmSrchListings" rel="search" action="<?php echo Utilities::generateUrl('account','paused_publications')?>">
          ...
          <div class="tbl-listing">
            <table>
              ...
              <tr>
                ...
                <td width="30%"><span class="cellcaption"><?php echo Utilities::getLabel('L_Name')?></span> <strong class="red-txt"><?php echo trim($row["prod_name"]) ?></strong><br>
		  ...
		  <?php else:?>
		        <div class="space-lft-right">
                	<div class="alert alert-info">
    	    			<?php echo Utilities::getLabel('L_You_do_not_have_paused_listings')?>
		        	</div>
                </div>
          <?php endif;?>
        </div>
