    ...
    <div class="fixed-container">
      <div class="dashboard">
        ...
        <div class="data-side">
          ...
          <h3><?php echo Utilities::getLabel('L_Change_Email')?></h3>
          <ul class="arrowTabs">
                 ...
                 <?php endif;?>
                 <li class="active"><a href="<?php echo Utilities::generateUrl('account', 'change_email')?>"><?php echo Utilities::getLabel('M_Change_Email')?></a></li>
          </ul>
