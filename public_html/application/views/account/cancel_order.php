    ...
    <div class="fixed-container">
      <div class="dashboard">
        ...
        <div class="data-side">
          ...
          <div class="box-head">
            <h3><?php echo Utilities::getLabel('L_Cancel_Order')?></h3>
            <div class="padding20 fr"> <a href="<?php echo Utilities::generateUrl('account', 'sales')?>" class="btn small"><?php echo Utilities::getLabel('L_My_Sales')?></a> </div>
          </div>
            ...
            <table class=" tbl-normal">
              <tbody>
                ...
                <?php 
					...
					//$cart_total_without_tax=$cart_total_with_tax*100/(100+$order_detail["order_vat_perc"]);
                ...
                <tr>
                  <td><span class="itemcaption"><?php echo Utilities::getLabel('L_Order_Total')?></span> <?php echo $currencyObj->format($order_detail["opr_net_charged"],$order_detail["order_currency_code"],$order_detail["order_currency_value"])?></td>
                  <td><?php if ($order_detail["opr_refund_qty"]>0):?>
                      <span class="itemcaption"><?php echo Utilities::getLabel('L_Refund_Qty')?>.</span> [<?php echo $order_detail["opr_refund_qty"]?>]
				  <?php endif;?></td>
                  <td><?php if ($order_detail["opr_refund_qty"]>0):?>
                      <span class="itemcaption"><?php echo Utilities::getLabel('L_Refund_Amount')?></span> <?php echo $currencyObj->format($order_detail["opr_refund_amount"],$order_detail["order_currency_code"],$order_detail["order_currency_value"])?>
                  <?php endif;?></td>
                </tr>
              </tbody>
            </table>
            ...
            <table class="tbl-normal">
              <tbody>
                ...
                <tr>
                  ...
                  <br/><strong><?php echo Utilities::getLabel('L_Code')?></strong>: <?php echo $sku_codes?></td>
		 ...
		 <?php endif;?>   
          ...
          <h3><?php echo Utilities::getLabel('L_Reason_for_cancellation')?></h3>
          <div class="space-lft-right">
            <div class=" wrapform">
