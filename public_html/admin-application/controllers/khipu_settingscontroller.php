<?php
class khipu_settingsController extends PaymentmethodsController {
    ...
    protected function getSettingsForm() {
		...
		$frm->addRequiredField('Receiver Id', 'receiver_id');
		$frm->addRequiredField('Secret key', 'secret_key');
	...
	function default_action() {
		...
		// var_dump($pmObj->getPaymentSettings());die;
