<?php
class AuthorizeAIM_settingsController extends PaymentmethodsController {
    ...
    protected function getSettingsForm() {
		...
		$frm->addRequiredField('Login ID', 'login_id');
		$frm->addRequiredField('Transaction Key', 'transaction_key');
		$frm->addTextBox('MD5 Hash', 'md5_hash');
