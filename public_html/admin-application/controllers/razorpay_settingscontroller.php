<?php
class Razorpay_settingsController extends PaymentmethodsController {
    ...
    protected function getSettingsForm() {
		...
		$frm->addRequiredField('Key ID', 'merchant_key_id');
		$frm->addRequiredField('Key Secret', 'merchant_key_secret');
