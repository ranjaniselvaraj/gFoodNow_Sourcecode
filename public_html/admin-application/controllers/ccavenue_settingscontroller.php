<?php
class CCAvenue_settingsController extends PaymentmethodsController {
    ...
    protected function getSettingsForm() {
		...
		$frm->addRequiredField('Access Code', 'access_code');
		$frm->addRequiredField('Working Key', 'working_key');
