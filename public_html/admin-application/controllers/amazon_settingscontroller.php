<?php
class Amazon_settingsController extends PaymentmethodsController {
    ...
    protected function getSettingsForm() {
		...
		$frm->addRequiredField('Merchant Id', 'amazon_merchantId');
		$frm->addRequiredField('Access Key', 'amazon_accessKey');
		$frm->addRequiredField('Secret Key', 'amazon_secretKey');
		$frm->addRequiredField('Client Id', 'amazon_clientId');
