			...
			<div class="row">
				<div class="col-sm-12">
					<section class="section">
						<div class="sectionhead"><h4>Edit - Blog Post </h4></div>
						<div class="sectionbody space">
							<?php echo $frmEdit->getFormTag(); ?>
							<div class="formhorizontal">
								<div class="field_control horizontal">
									...
									<div class="field_cover">
										<?php echo $frmEdit->getFieldHtml('post_title'); ?>
									</div>
								</div>
								<div class="field_control horizontal">
									<label class="field_label">Post Contributor Name<span class="spn_must_field"></span></label>
									<div class="field_cover">
										<?php echo $frmEdit->getFieldHtml('post_contributor_name'); ?>
									</div>
								</div>   
								<div class="field_control horizontal">
									<label class="field_label">Post SEO Name<span class="spn_must_field">*</span></label>
									<div class="field_cover">
										<?php echo $frmEdit->getFieldHtml('post_seo_name'); ?>
									</div>
								</div>
								<div class="field_control horizontal">
									<label class="field_label">Post Short Description</label>
									<div class="field_cover">
										<?php echo $frmEdit->getFieldHtml('post_short_description'); ?>
									</div>
								</div>
								<div class="field_control horizontal">
									<label class="field_label">Post Content<span class="spn_must_field">*</span></label>
									<div class="field_cover">
										<?php echo $frmEdit->getFieldHtml('post_content'); ?>
									</div>
								</div>
								<div class="field_control horizontal">
									<label class="field_label">Post Image</label>
									<?php 
										echo Utilities::renderView(Utilities::getViewsPartialPath().'upload_images.php');
										echo html_entity_decode($photo_html);
									?>
									<!--  <div id="image_div"><?php echo $frmEdit->getFieldHtml('post_image_file_name[]'); ?></div>-->
								</div>
								...
								<div class="field_control horizontal">
									...
									<div class="field_cover">
										<div class="selectfield">
											<?php echo $frmEdit->getFieldHtml('post_comment_status'); ?>
										</div>
									</div>
								</div>
								<div class="field_control horizontal">
								...
								<div class="field_control horizontal">
									...
									<div class="field_cover">
										<?php echo $frmEdit->getFieldHtml('meta_title'); ?>
									</div>
								</div>
								<div class="field_control horizontal">
									<label class="field_label">Meta Keyword</label>
									<div class="field_cover">
										<?php echo $frmEdit->getFieldHtml('meta_keywords'); ?>
									</div>
								</div>
								<div class="field_control horizontal">
									<label class="field_label">Meta Description</label>
									<div class="field_cover">
										<?php echo $frmEdit->getFieldHtml('meta_description'); ?>
									</div>
								</div>
								<div class="field_control horizontal">
									<label class="field_label">Meta Other</label>
									<div class="field_cover">
										<?php echo $frmEdit->getFieldHtml('meta_others'); ?>
								...
								<div class="field_control horizontal">
									...
									<div class="field_cover">
										<div class="selectfield">
											<?php echo $frmEdit->getFieldHtml('post_status'); ?>
										</div>
									</div>
								</div>
								<div class="field_control horizontal">
