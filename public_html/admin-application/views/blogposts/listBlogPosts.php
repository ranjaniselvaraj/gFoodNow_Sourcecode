        ...
        foreach ($records as $record) {
            ...
            <tr>
                ...
                <td><?php echo displayDate($record['post_date_time']) ?></td>
                    <?php if ($canview === true) { ?><td>
                        <?php
                        echo '<ul class = "actions">
               <li><a title = "Edit"  href = "' . Utilities::generateUrl('blogposts', 'edit', array($record['post_id'])) . '" ><i class ="ion-edit icon"></i></a></li>
               <li><a href="#" title = "Delete" onclick="return confirmDelete(this);" data-href = "' . Utilities::generateUrl('blogposts', 'delete', array($record['post_id'])) . '" ><i class ="ion-android-delete icon"></i></a></li>
				</ul>';
                    }
                    ?></td>
            </tr>
