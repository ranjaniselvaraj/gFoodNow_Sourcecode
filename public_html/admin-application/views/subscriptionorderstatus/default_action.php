...
<div id="body">
	...
	<div class="page">
		<ul class="breadcrumb flat">
			...
			<li>Subscription Order Statuses</li>
		</ul>
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<section class="section"> <div id="form-div"></div>
                        <div class="sectionhead"><h4>Manage - Subscription Order Statuses</h4>
						<ul class="actions">
                                <li class="droplink">
                                    <a href="javascript:void(0);"><i class="ion-android-more-vertical icon"></i></a>
                                    <div class="dropwrap">
                                        <ul class="linksvertical">
                                            <li><a href="<?php echo Utilities::generateUrl('subscriptionorderstatus', 'form'); ?>" >Add Order Status</a></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                          ...
                          <table class="table table-responsive" id="dtTable">
                                        ...
                                        <tbody>
                                          <?php foreach ($arr_listing as $sn=>$row) {  ?>
											<tr>
												<td><?php echo trim($row["sorder_status_name"]) ?></td>
												<td class="text-center" nowrap="nowrap">
												<ul class="actions">
													<li><a href="<?php echo Utilities::generateUrl('subscriptionorderstatus', 'form', array($row['sorder_status_id']))?>" title="Edit"><i class="ion-edit icon"></i></a></li>
													<li><a onclick="return(confirm('Are you sure to delete this record?'));" href="<?php echo Utilities::generateUrl('subscriptionorderstatus', 'delete', array($row['sorder_status_id']))?>" title="Delete"><i class="ion-android-delete icon"></i></a></li>													
													</ul>
