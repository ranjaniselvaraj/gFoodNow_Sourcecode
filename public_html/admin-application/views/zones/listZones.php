    ...
    if (!$records || !is_array($records)) {
        ...
        foreach ($records as $record) {
            ...
            <tr>
			   ...
			   <li><a title = "Edit"  href = "' . Utilities::generateUrl('zones', 'form', array($record['zone_id'])) . '" ><i class ="ion-edit icon"></i></a></li>
               <li><a title = "Delete" href="javascript:void(0);" onclick="ConfirmDelete(' . $record['zone_id'] . ', $(this));" ><i class ="ion-android-delete icon"></i></a></li>
				</ul>';
                    }
                    ?></td>
            </tr>
