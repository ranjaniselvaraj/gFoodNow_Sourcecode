...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
    ...
    if (!$records || !is_array($records)) {
        ...
        foreach ($records as $record) {
            ...
            <tr>
                <td><?php echo $i; ?></td>
                <td><?php echo trim($record["state_name"]) ?></td>
			   ...
			   <li><a title = "Edit"  href = "' . Utilities::generateUrl('states', 'form', array($record['state_id'])) . '" ><i class ="ion-edit icon"></i></a></li>
               <li><a title = "Delete" href="javascript:void(0);" onclick="ConfirmDelete(' . $record['state_id'] . ', $(this));" ><i class ="ion-android-delete icon"></i></a></li>
				</ul>';
                    }
                    ?></td>
            </tr>
