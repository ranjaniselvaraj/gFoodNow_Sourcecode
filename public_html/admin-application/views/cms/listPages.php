                ...
                <?php if ($canview === true) {?>
                    <td>
                        ...
                        echo '<ul class = "actions">
						   <li><a title = "Edit"  href = "' . Utilities::generateUrl('cms', 'form', array($record['page_id'])) . '" ><i class ="ion-edit icon"></i></a></li>
            			   <li><a title = "Delete" href="javascript:void(0);" onclick="ConfirmCmsPageDelete(' . $record['page_id'] . ', $(this));" ><i class ="ion-android-delete icon"></i></a></li>
				</ul>';
                    }
                    ?></td>
            </tr>
