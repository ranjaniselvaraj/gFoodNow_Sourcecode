...
class Ship {
    ...
    public function __construct() {
        ...
        require_once('vendor/shipstation/libraries/unirest/Unirest.php');
        require_once('vendor/shipstation/libraries/shipstation/Shipstation.class.php');
	 ...
	 public function getPackages($carier_code) {
		 if (!$list = $this->shipstation->getServices($carier_code)) {
            $error = $this->shipstation->getLastError();
            throw new Exception($error->message);
        }
        return $list;
        //return $this->shipstation->getCarriers();
    }
