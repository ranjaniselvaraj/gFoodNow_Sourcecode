...
require_once 'APIs/Mailchimp/Folders.php';
require_once 'APIs/Mailchimp/Templates.php';
require_once 'APIs/Mailchimp/Users.php';
require_once 'APIs/Mailchimp/Helper.php';
require_once 'APIs/Mailchimp/Mobile.php';
require_once 'APIs/Mailchimp/Conversations.php';
require_once 'APIs/Mailchimp/Ecomm.php';
require_once 'APIs/Mailchimp/Neapolitan.php';
require_once 'APIs/Mailchimp/Lists.php';
require_once 'APIs/Mailchimp/Campaigns.php';
require_once 'APIs/Mailchimp/Vip.php';
require_once 'APIs/Mailchimp/Reports.php';
require_once 'APIs/Mailchimp/Gallery.php';
require_once 'APIs/Mailchimp/Goal.php';
require_once 'APIs/Mailchimp/Exceptions.php';
